...
/**
 * Returns combined options. Default options are overwritten by user defined attributes.
 *
 * @param {Object} User options
 * @return {Object}
 */
exports.combineOptions = function (localOptions) {
    ...
    return extend(options, localOptions);
};
